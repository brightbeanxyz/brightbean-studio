    ...
    provider._request.assert_has_calls(
        [
            ...
            call(
                ...
                "https://graph.facebook.com/v25.0/ig-1/insights",
                access_token="page-token",
                params={"metric": "profile_views", "period": "day", "since": 1781740800, "until": 1781827200, "metric_type": "total_value"},
            ),
            call(
                "GET",
                "https://graph.facebook.com/v25.0/ig-1/insights",
                access_token="page-token",
                params={"metric": "accounts_engaged", "period": "day", "since": 1781740800, "until": 1781827200, "metric_type": "total_value"},
            ),
            call(
                "GET",
                "https://graph.facebook.com/v25.0/ig-1/insights",
                access_token="page-token",
                params={"metric": "total_interactions", "period": "day", "since": 1781740800, "until": 1781827200, "metric_type": "total_value"},
            ),
            call(
                "GET",
